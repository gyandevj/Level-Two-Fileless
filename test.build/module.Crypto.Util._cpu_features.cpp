...
static PyCodeObject *codeobj_5f46ca2430620a77608210e1a0ae3872;
static PyCodeObject *codeobj_d5cf0aa9ec80ed482340b9a335becec7;
static PyCodeObject *codeobj_1ac72f2f77ef42a76d9b600373ef77d9;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[14]); CHECK_OBJECT(module_filename_obj);
    codeobj_5f46ca2430620a77608210e1a0ae3872 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[15], NULL, NULL, 0, 0, 0);
    codeobj_d5cf0aa9ec80ed482340b9a335becec7 = MAKE_CODEOBJECT(module_filename_obj, 41, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[1], NULL, NULL, 0, 0, 0);
    codeobj_1ac72f2f77ef42a76d9b600373ef77d9 = MAKE_CODEOBJECT(module_filename_obj, 45, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[2], NULL, NULL, 0, 0, 0);
}
...
static PyObject *impl_Crypto$Util$_cpu_features$$$function__1_have_aes_ni(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    struct Nuitka_FrameObject *frame_d5cf0aa9ec80ed482340b9a335becec7;
    ...
    static struct Nuitka_FrameObject *cache_frame_d5cf0aa9ec80ed482340b9a335becec7 = NULL;

    // Actual function body.
    if (isFrameUnusable(cache_frame_d5cf0aa9ec80ed482340b9a335becec7)) {
        Py_XDECREF(cache_frame_d5cf0aa9ec80ed482340b9a335becec7);

#if _DEBUG_REFCOUNTS
        if (cache_frame_d5cf0aa9ec80ed482340b9a335becec7 == NULL) {
...
#endif
        cache_frame_d5cf0aa9ec80ed482340b9a335becec7 = MAKE_FUNCTION_FRAME(codeobj_d5cf0aa9ec80ed482340b9a335becec7, module_Crypto$Util$_cpu_features, 0);
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    }
    assert(cache_frame_d5cf0aa9ec80ed482340b9a335becec7->m_type_description == NULL);
    frame_d5cf0aa9ec80ed482340b9a335becec7 = cache_frame_d5cf0aa9ec80ed482340b9a335becec7;

    // Push the new frame as the currently active one.
    pushFrameStack(frame_d5cf0aa9ec80ed482340b9a335becec7);

    // Mark the frame object as in use, ref count 1 will be up for reuse.
    assert(Py_REFCNT(frame_d5cf0aa9ec80ed482340b9a335becec7) == 2); // Frame stack
    ...
    // Framed code:
    {
        ...
        frame_d5cf0aa9ec80ed482340b9a335becec7->m_frame.f_lineno = 42;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_d5cf0aa9ec80ed482340b9a335becec7);
#endif
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_d5cf0aa9ec80ed482340b9a335becec7, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_d5cf0aa9ec80ed482340b9a335becec7->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_d5cf0aa9ec80ed482340b9a335becec7, exception_lineno);
    }

    // Attaches locals to frame if any.
    Nuitka_Frame_AttachLocals(
        frame_d5cf0aa9ec80ed482340b9a335becec7,
        type_description_1
    );


    // Release cached frame if used for exception.
    if (frame_d5cf0aa9ec80ed482340b9a335becec7 == cache_frame_d5cf0aa9ec80ed482340b9a335becec7) {
#if _DEBUG_REFCOUNTS
        count_active_frame_cache_instances -= 1;
        count_released_frame_cache_instances += 1;
#endif

        Py_DECREF(cache_frame_d5cf0aa9ec80ed482340b9a335becec7);
        cache_frame_d5cf0aa9ec80ed482340b9a335becec7 = NULL;
    }

    assertFrameObject(frame_d5cf0aa9ec80ed482340b9a335becec7);
...
static PyObject *impl_Crypto$Util$_cpu_features$$$function__2_have_clmul(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Local variable declarations.
    struct Nuitka_FrameObject *frame_1ac72f2f77ef42a76d9b600373ef77d9;
    NUITKA_MAY_BE_UNUSED char const *type_description_1 = NULL;
    PyObject *tmp_return_value = NULL;
    PyObject *exception_type = NULL;
    PyObject *exception_value = NULL;
    PyTracebackObject *exception_tb = NULL;
    NUITKA_MAY_BE_UNUSED int exception_lineno = 0;
    static struct Nuitka_FrameObject *cache_frame_1ac72f2f77ef42a76d9b600373ef77d9 = NULL;

    // Actual function body.
    if (isFrameUnusable(cache_frame_1ac72f2f77ef42a76d9b600373ef77d9)) {
        Py_XDECREF(cache_frame_1ac72f2f77ef42a76d9b600373ef77d9);

#if _DEBUG_REFCOUNTS
        if (cache_frame_1ac72f2f77ef42a76d9b600373ef77d9 == NULL) {
            count_active_frame_cache_instances += 1;
        } else {
            count_released_frame_cache_instances += 1;
        }
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_1ac72f2f77ef42a76d9b600373ef77d9 = MAKE_FUNCTION_FRAME(codeobj_1ac72f2f77ef42a76d9b600373ef77d9, module_Crypto$Util$_cpu_features, 0);
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    }
    assert(cache_frame_1ac72f2f77ef42a76d9b600373ef77d9->m_type_description == NULL);
    frame_1ac72f2f77ef42a76d9b600373ef77d9 = cache_frame_1ac72f2f77ef42a76d9b600373ef77d9;

    // Push the new frame as the currently active one.
    pushFrameStack(frame_1ac72f2f77ef42a76d9b600373ef77d9);

    // Mark the frame object as in use, ref count 1 will be up for reuse.
    assert(Py_REFCNT(frame_1ac72f2f77ef42a76d9b600373ef77d9) == 2); // Frame stack
    ...
    // Framed code:
    {
        ...
        frame_1ac72f2f77ef42a76d9b600373ef77d9->m_frame.f_lineno = 46;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_1ac72f2f77ef42a76d9b600373ef77d9);
#endif
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_1ac72f2f77ef42a76d9b600373ef77d9, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_1ac72f2f77ef42a76d9b600373ef77d9->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_1ac72f2f77ef42a76d9b600373ef77d9, exception_lineno);
    }

    // Attaches locals to frame if any.
    Nuitka_Frame_AttachLocals(
        frame_1ac72f2f77ef42a76d9b600373ef77d9,
        type_description_1
    );


    // Release cached frame if used for exception.
    if (frame_1ac72f2f77ef42a76d9b600373ef77d9 == cache_frame_1ac72f2f77ef42a76d9b600373ef77d9) {
#if _DEBUG_REFCOUNTS
        count_active_frame_cache_instances -= 1;
        count_released_frame_cache_instances += 1;
#endif

        Py_DECREF(cache_frame_1ac72f2f77ef42a76d9b600373ef77d9);
        cache_frame_1ac72f2f77ef42a76d9b600373ef77d9 = NULL;
    }

    assertFrameObject(frame_1ac72f2f77ef42a76d9b600373ef77d9);
...
static PyObject *MAKE_FUNCTION_Crypto$Util$_cpu_features$$$function__1_have_aes_ni() {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        NULL,
#endif
        codeobj_d5cf0aa9ec80ed482340b9a335becec7,
        NULL,
#if PYTHON_VERSION >= 0x300
        NULL,
        NULL,
...
static PyObject *MAKE_FUNCTION_Crypto$Util$_cpu_features$$$function__2_have_clmul() {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        NULL,
#endif
        codeobj_1ac72f2f77ef42a76d9b600373ef77d9,
        NULL,
#if PYTHON_VERSION >= 0x300
        NULL,
        NULL,
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_5f46ca2430620a77608210e1a0ae3872;
    NUITKA_MAY_BE_UNUSED char const *type_description_1 = NULL;
    bool tmp_result;
    PyObject *exception_type = NULL;
    PyObject *exception_value = NULL;
    ...
    // Frame without reuse.
    frame_5f46ca2430620a77608210e1a0ae3872 = MAKE_MODULE_FRAME(codeobj_5f46ca2430620a77608210e1a0ae3872, module_Crypto$Util$_cpu_features);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_5f46ca2430620a77608210e1a0ae3872);
    assert(Py_REFCNT(frame_5f46ca2430620a77608210e1a0ae3872) == 2);
    ...
    }
    {
        ...
        frame_5f46ca2430620a77608210e1a0ae3872->m_frame.f_lineno = 31;
    ...
    }
    {
        ...
        frame_5f46ca2430620a77608210e1a0ae3872->m_frame.f_lineno = 34;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_5f46ca2430620a77608210e1a0ae3872);
#endif
    popFrameStack();

    assertFrameObject(frame_5f46ca2430620a77608210e1a0ae3872);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_5f46ca2430620a77608210e1a0ae3872, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_5f46ca2430620a77608210e1a0ae3872->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_5f46ca2430620a77608210e1a0ae3872, exception_lineno);
    }
